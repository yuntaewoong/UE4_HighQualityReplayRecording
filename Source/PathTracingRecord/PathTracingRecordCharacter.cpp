...
APathTracingRecordCharacter::APathTracingRecordCharacter()
{
...
void APathTracingRecordCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &APathTracingRecordCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &APathTracingRecordCharacter::MoveRight);
...
void APathTracingRecordCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
